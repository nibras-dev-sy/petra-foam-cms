...
export interface ApiAboutUsInfoAboutUsInfo extends Struct.SingleTypeSchema {
  collectionName: 'about_us_infos';
  info: {
    description: '';
    displayName: 'About Us Info';
    pluralName: 'about-us-infos';
    singularName: 'about-us-info';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-us-info.about-us-info'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    catalogue: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-us-info.about-us-info': ApiAboutUsInfoAboutUsInfo;
